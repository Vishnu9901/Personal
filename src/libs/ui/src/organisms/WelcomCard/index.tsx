...
export const WelcomeCard = () => {
    ...
    return (<>
        <div className="container flex flex-col lg:flex-row px-6 lg:pl-appPaddingLeft lg:pr-appPaddingRight mx-auto pt-12 pb-8 gap-8 lg:justify-center lg:items-center divide-y divide-neutral-300 lg:divide-y-0">
            ...
            <div className="basis-1/2 pt-6 lg:pt-0">
                ...
                {currentForm === LoginModalConstant.AlreadyRegistered && <>
                    <AlreadyRegistered mode="modal" onSubmit={onSubmit} loginModal={() => { forgotPassword(LoginModalConstant.ForgotPassword) }}></AlreadyRegistered>
                </>}
            </div>
        </div>
    </>)
